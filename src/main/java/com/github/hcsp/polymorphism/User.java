...
public class User {
    ...
    //判断条件是否成立,predicate内部有一个test方法来帮我们判断
    /*private interface Predicate<User> {
        boolean condition(User user);
    }*/

    /*//判断id是不是偶数
    private static class idIsOuShu implements User.Predicate<User> {
        @Override
        public boolean condition(User user) {
            return user.id % 2 == 0;
        }
    }*/
